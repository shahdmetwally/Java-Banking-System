...
//-----------------------------------
   ...
   public String viewAccountNo(Customer customer){
    ...
    public String removeManager(Integer personalNo) throws Exception {
        String removeResult = "";
        Manager manager = getManager(String.valueOf(personalNo));
        if (manager == null) {
...
// show the manager or the admin do this?
    public void promoteEmployee(Integer personalNo, double newSalary, double bonus) throws Exception {
        ...
        if(employee.getPersonalNo() == personalNo) {
